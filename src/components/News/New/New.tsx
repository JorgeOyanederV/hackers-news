...
export const New: FC = ({ _new }) => {
  ...
  const { author, story_title, created_at, objectID, isFaves } = _new;
  ...
  return (
    <div className="w-full md:h-[90px] pl-[26px] flex border border-[#979797] rounded-[6px] hover:opacity-50 cursor-pointer">
